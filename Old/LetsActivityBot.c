...
int main()
{
    ...
    if (c != -1) {
      ...
      if ((int)c == 13 || (int)c == 10) {
        ...
        if (strcmp(inputString, "l") == 0) {
          dprint(term, "left");
          Step(-defaultTurnSpeed, defaultTurnSpeed);
        }          
        ...
        if (strcmp(inputString, "f") == 0) {
          dprint(term, "forward");
          Step(defaultStraightSpeed, defaultStraightSpeed);
        }          
        if (strcmp(inputString, "b") == 0) {
          dprint(term, "back");
          Step(-defaultStraightSpeed, -defaultStraightSpeed*2);
        }          
        sPos = 0;
  ...
  while (0)
  {
    ...
    if (c != -1)
    {
      ...
      //if (verbose) dprint(term, "You typed: %c\n", c);
...
void Step(int leftSpeed, int rightSpeed)
{
  ...
  pause(100);
  drive_speed(leftSpeed/2, rightSpeed/2);
  pause(100);
  drive_speed(0, 0);
}  
